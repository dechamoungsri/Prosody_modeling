...
def run_training(db_file, name_out_path):
    ...
    for syl in db:
        feat = syl['TF']['intepolate151_normalize_by_preprocessing.normalize']['data']
        Y.append(feat)
        names.append(syl['id'])
        # sys.exit()
...
if __name__ == '__main__':
    ...
    out_path = '/work/w23/decha/decha_w23/Second_Journal/Latent_space_training_result/08c_preprocessing_normaiize/input_dim_10/'
