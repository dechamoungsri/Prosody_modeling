...
def run_training(db_file, name_out_path, data_type):
...
if __name__ == '__main__':
    ...
    out_path = '/work/w23/decha/decha_w23/Second_Journal/Latent_space_training_result/12c_normalization_by_preprocessing_of_11_data/input_dim_10/'
        ...
        for f in ['nasal', 'no', 'non-nasal']:
            for v in ['long', 'short']:
                ...
                if Utility.is_file_exist(db_file):
                    ...
                    try:
                        # k = 0 + 'a'
                        run_training(db_file, name_out_path, data_type)
                    except Exception, e:
