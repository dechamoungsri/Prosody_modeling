...
def run_training(db_file, name_out_path):
    ...
    for syl in db:
        feat = syl['TF']['intepolate51_normailize_no_diff']['data']
        Y.append(feat)
        names.append(syl['id'])
        # sys.exit()
...
if __name__ == '__main__':
    ...
    db_path = '/work/w2/decha/Data/GPR_speccom_data/syllable_database/07_normalize_of_04_no_diff_features/'

    out_path = '/work/w23/decha/decha_w23/Second_Journal/Latent_space_training_result/07_02a_no_diff/input_dim_10/'
