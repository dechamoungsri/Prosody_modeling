...
def svm_classifier(train_data, train_label, test_data, test_label, output_figure, plane, xx, yy, most_dominants, inverse_lengthscale):
    ...
    # fit the model
    clf = svm.SVC( kernel=rbf_kernel, verbose=True, class_weight={1: 10})
...
if __name__ == '__main__':
    ...
    method_14_dim_10 = {
        ...
        'out_path' : './figure_gplvm_class_weight/',
    ...
    Utility.save_obj(syl_dict, './by_product_dict_3_level_of_stress_class_weight.pkl')
