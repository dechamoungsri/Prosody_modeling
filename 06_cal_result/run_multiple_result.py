...
if __name__ == '__main__':
    ...
    b_path = '/work/w23/decha/decha_w23/Second_Journal/Unsupervised_learning_result/'

    db_path = '/work/w2/decha/Data/GPR_speccom_data/syllable_database/13_merge_vowel_08c/'

    # for method in ['001a_gplvm', '002a_pca']:
    for method in ['01a_gplvm_rerun', '02a_pca_rerun']:

        # for dim in [2,5,10,20]:
        for dim in [2,5,10,20]:

            base_path = '{}/{}_dim{}/'.format(b_path, method, dim)
