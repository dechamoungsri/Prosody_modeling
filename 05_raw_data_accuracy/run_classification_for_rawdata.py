...
def link_clustering(x, inverselengthscale, n_clusters, n_neighbors):
    ...
    clustering = AgglomerativeClustering(linkage=linkage, n_clusters=n_clusters, connectivity=knn_graph)
    clustering.fit(x)
...
if __name__ == '__main__':
    ...
    out_path = '/work/w23/decha/decha_w23/Second_Journal/Unsupervised_learning_result/00_raw_data_link_clustering_accuracy/'
