...
def run_processor(db_file, name_out_path, name, base_path, set_n_cluster, set_n_neighbors ):

    real = run_data_processor(db_file)

    Y = Utility.load_obj('{}/pca_reduction_output.pkl'.format(base_path))
    ...
    for n_cluster in set_n_cluster:
        # for n_neighbors in [0.025, 0.05, 0.075, 0.1, 0.2, 0.5, 0.75, 0.8, 0.9]:
        for n_neighbors in set_n_neighbors:
...
def cal_accuracy_and_f1(real, pred, log_cal_path):
    ...
    for i in xrange(1, len(s)):
        ...
        for a in ss:
            ...
            # print 'acc 1 result ', acc_1, f1_1
            # print 'acc 1 result ', acc_2, f1_2
...
if __name__ == '__main__':
    ...
    o = '/work/w23/decha/decha_w23/Second_Journal/Unsupervised_learning_result/002a_pca/'

    set_n_cluster = [2]
    set_n_neighbors = [0.025, 0.05, 0.075, 0.1, 0.2, 0.5, 0.75, 0.8, 0.9]

    for dim in [2, 5, 10, 20]:

        out_path = '{}/dim_{}/'.format(o, dim)
        model_path = '/work/w23/decha/decha_w23/Second_Journal/Latent_space_training_result/15_merge_pca_13/input_dim_{}/'.format(dim)
        ...
        for t in xrange(5):
            for f in ['nasal', 'no', 'non-nasal']:
                ...
                if Utility.is_file_exist(db_file):
                    ...
                    run_processor(db_file, name_out_path, name, base_path, set_n_cluster, set_n_neighbors)
                    # sys.exit()
