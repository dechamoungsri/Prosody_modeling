...
def normalize_data(db_file, name_out_path):
    ...
    for idx, syl in enumerate(db):
        ...
        syl['TF']['missing151_robust_scale']['description'] = 'robust_scale version of missing151'
...
if __name__ == '__main__':
    ...
    out_path = '/work/w2/decha/Data/GPR_speccom_data/syllable_database/10b_robustsacle_of_03/'
