...
def normalize_data(db_file, name_out_path):
    ...
    for idx, syl in enumerate(db):
        ...
        syl['TF']['intepolate151_normalize_by_preprocessing.normalize']['data'] = X_normalized[idx]
        syl['TF']['intepolate151_normalize_by_preprocessing.normalize']['description'] = 'preprocessing.normalize version of intepolate151'
...
if __name__ == '__main__':
    ...
    out_path = '/work/w2/decha/Data/GPR_speccom_data/syllable_database/08c_normalize_of_04/'
